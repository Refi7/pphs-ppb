...
import imagesatu from './image/gpaket.png'
  ...
  return (
    <View style={styles.Container}>
      ...
      <View style={{ alignSelf: 'center', marginTop: 60}}>
        <TouchableOpacity style={styles.Tombolnext} onPress={()=> navigation.navigate('Login')}>
          <Text style={styles.Tekstombolnext}>GET STARTED</Text>
        </TouchableOpacity>
      </View>
    </View>
  )
